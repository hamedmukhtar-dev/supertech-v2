...
email = st.text_input("Email", key="REGISTER_TEXT_INPUT_5a0ed4")
country = st.text_input("Country", key="REGISTER_TEXT_INPUT_914549")
ip = st.text_input("IP Address (auto-filled)", value=st.session_state.get("ip", ""), key="REGISTER_TEXT_INPUT_fc80fe")
