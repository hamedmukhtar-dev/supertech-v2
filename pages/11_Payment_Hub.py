...
method = st.selectbox("Payment Method", SUPPORTED_METHODS, key="paymenthub_PAYMENT_METHOD_2d17cd")
amount = st.number_input("Amount", step=1.0, key="paymenthub_AMOUNT_73bd2a")
