...
def show_pilot_form():
    ...
    with st.form("pilot_signup_form"):
        full_name = st.text_input(_(f"Full Name"), key="streamlit_app_FULL_NAME_23f04a")
        email = st.text_input(_(f"Email"), key="streamlit_app_EMAIL_99bfe5")
        phone = st.text_input(_(f"Phone Number"), key="streamlit_app_PHONE_109bd0")
        ...
        notes = st.text_area(_(f"Notes / What do you expect?"), key="streamlit_app_NOTES_476de8")
