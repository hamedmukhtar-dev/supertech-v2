...
def show_pilot_form():
    ...
    with st.form("pilot_signup_form"):
        full_name = st.text_input(_(f"Full Name"), key="STREAMLIT_APP_TEXT_INPUT_d79bf8")
        email = st.text_input(_(f"Email"), key="STREAMLIT_APP_TEXT_INPUT_acf7af")
        phone = st.text_input(_(f"Phone Number"), key="STREAMLIT_APP_TEXT_INPUT_bc31e1")
        ...
        notes = st.text_area(_(f"Notes / What do you expect?"), key="STREAMLIT_APP_TEXT_AREA_796464")
